...
class FinanceFreelancerInvoiceController extends Controller
{
    public function index(Request $request)
    {
        ...
        foreach ($invoices as $invoice) {
            $invoice->freelancer_exists = $invoice->freelancer_code ? \App\Models\Freelancer::where('freelancer_code', $invoice->freelancer_code)->exists() : false;
    ...
    public function show(FinanceFreelancerInvoice $financeFreelancerInvoice)
    {
        Gate::authorize('View Vendor Invoice');
        ...
        $freelancer = null;
        if ($financeFreelancerInvoice->freelancer_code) {
            $freelancer = \App\Models\Freelancer::where('freelancer_code', $financeFreelancerInvoice->freelancer_code)->first();
        }

        // Check if task exists
        $task = null;
        if ($financeFreelancerInvoice->task_code) {
            $task = \App\Models\Task::where('task_number', $financeFreelancerInvoice->task_code)->first();
        }

        return view('dashboard.finance.invoices.finance-freelancer-invoices.show', compact('financeFreelancerInvoice', 'freelancer', 'task'));
    }
    ...
    {
        Gate::authorize('Download Finance Freelancer Invoice File');
    ...
    {
        Gate::authorize('Delete Finance Freelancer Invoice File');
